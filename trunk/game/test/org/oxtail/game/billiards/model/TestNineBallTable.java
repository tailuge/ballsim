...
public class TestNineBallTable {
	...
	public void testRack() {
		...
		assertEquals("expect all balls on table",10, table.getBallsLeftOnTable().size());
	}
	...
	public void testBallCategory() {
		...
		{
			assertEquals("expect nineball category",ball.getCategory().getGameCategory(),BilliardsGameCategory.NineBall );			
		}		
	}
	...
	public void testGetNextBallToHit()
	{
		...
		assertEquals("expect 1 ball is first to hit",ball.getCategory().getBallCategory(),BilliardBallId.ONE);
	}
